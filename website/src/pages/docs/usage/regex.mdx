# Using the RegularExpression Scalar Factory

## Using the RegularExpression scalar

First an explanation: To create a new scalar type for the GraphQL schema language, you must create an instance of a new `GraphQLScalarType` object that implements three general functions/methods:
...
```javascript filename="resolver.js"
export default {
  MyRegexType,
};
```
