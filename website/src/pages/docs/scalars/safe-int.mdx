...
The [GraphQL spec](https://facebook.github.io/graphql/#sec-Int) limits its Int type to 32-bits. Maybe you've seen this
error before: [issue on graphql-js](https://github.com/graphql/graphql-js/issues/292).

<Callout>
  Based on [graphql-bigint](https://github.com/stems/graphql-bigint). Even though stems' implementation looks the same
