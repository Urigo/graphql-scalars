...
import { GraphQLPhoneNumber } from '../src/scalars/PhoneNumber';
...
describe('PhoneNumber', () => {
  describe('valid', () => {
    ...
    test('parseLiteral', () => {
      expect(GraphQLPhoneNumber.parseLiteral({ value: '+16075551234', kind: Kind.STRING }, {})).toBe('+16075551234');
    });
  });
  ...
  describe('invalid', () => {
    describe('not a phone number', () => {
      ...
      test('parseLiteral', () => {
        expect(() =>
          GraphQLPhoneNumber.parseLiteral({ value: 'this is not a phone number', kind: Kind.STRING }, {})
    ...
    describe('too long', () => {
      ...
      test('parseLiteral', () => {
        expect(() => GraphQLPhoneNumber.parseLiteral({ value: '+1789555123456789', kind: Kind.STRING }, {})).toThrow(
          /^Value is not a valid phone number of the form \+17895551234 \(7-15 digits\)/
        );
      });
    });
    ...
    describe('too small', () => {
      ...
      test('parseLiteral', () => {
        expect(() => GraphQLPhoneNumber.parseLiteral({ value: '+123', kind: Kind.STRING }, {})).toThrow(
          /^Value is not a valid phone number of the form \+17895551234 \(7-15 digits\)/
        );
      });
    });
    ...
    describe('no plus sign', () => {
      ...
      test('parseLiteral', () => {
        expect(() => GraphQLPhoneNumber.parseLiteral({ value: '17895551234', kind: Kind.STRING }, {})).toThrow(
          /^Value is not a valid phone number of the form \+17895551234 \(7-15 digits\)/
        );
      });
    });
