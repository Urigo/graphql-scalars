...
import { GraphQLNonPositiveInt } from '../src/scalars/NonPositiveInt';
...
describe('NonPositiveInt', () => {
  describe('valid', () => {
    describe('as int', () => {
      ...
      test('parseLiteral', () => {
        expect(GraphQLNonPositiveInt.parseLiteral({ value: '-123', kind: Kind.INT }, {})).toBe(-123);
      });
    });
  ...
  describe('invalid', () => {
    describe('null', () => {
      ...
      test('parseLiteral', () => {
        expect(() => GraphQLNonPositiveInt.parseLiteral({ value: null, kind: Kind.INT }, {})).toThrow(
    ...
    describe('undefined', () => {
      ...
      test('parseLiteral', () => {
        expect(() => GraphQLNonPositiveInt.parseLiteral({ value: undefined, kind: Kind.INT }, {})).toThrow(
          /Value is not a number/
        );
      });
    });
    ...
    describe('unsafe integer', () => {
      test('serialize', () => {
        expect(() => GraphQLNonPositiveInt.serialize(2 ** 53)).toThrow(/Value is not a safe integer/);
      });

      test('parseValue', () => {
        expect(() => GraphQLNonPositiveInt.parseValue(2 ** 53)).toThrow(/Value is not a safe integer/);
      });

      test('parseLiteral', () => {
        expect(() => GraphQLNonPositiveInt.parseLiteral({ value: (2 ** 53).toString(), kind: Kind.INT }, {})).toThrow(
    ...
    describe('more than zero', () => {
      describe('as int', () => {
        test('serialize', () => {
          expect(() => GraphQLNonPositiveInt.serialize(1)).toThrow(/Value is not a non-positive number/);
        });

        test('parseValue', () => {
          expect(() => GraphQLNonPositiveInt.parseValue(1)).toThrow(/Value is not a non-positive number/);
        });

        test('parseLiteral', () => {
          expect(() => GraphQLNonPositiveInt.parseLiteral({ value: '1', kind: Kind.INT }, {})).toThrow(
    ...
    describe('infinity', () => {
      test('serialize', () => {
        expect(() => GraphQLNonPositiveInt.serialize(Number.NEGATIVE_INFINITY)).toThrow(/Value is not a finite number/);
      });
    ...
    describe('not a number', () => {
      test('serialize', () => {
        expect(() => GraphQLNonPositiveInt.serialize('not a number')).toThrow(/Value is not a number/);
      });

      test('parseValue', () => {
        expect(() => GraphQLNonPositiveInt.parseValue('not a number')).toThrow(/Value is not a number/);
      });
    ...
    describe('NaN', () => {
      ...
      test('parseLiteral', () => {
        expect(() =>
          GraphQLNonPositiveInt.parseLiteral({ value: Number.NaN.toString(), kind: Kind.STRING }, {})
        ).toThrow(/Can only validate integers as non-positive integers but got a/);
      });
    });
  });
