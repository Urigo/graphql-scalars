...
describe('PhoneNumber', () => {
  describe('valid', () => {
    ...
    test('parseValue', () => {
      expect(GraphQLPhoneNumber.parseValue('+16075551234')).toBe(
        '+16075551234',
      );
    });
    ...
    test('parseLiteral', () => {
      expect(
        GraphQLPhoneNumber.parseLiteral(
          { value: '+16075551234', kind: Kind.STRING },
          {},
        ),
      ).toBe('+16075551234');
    });
  ...
  describe('invalid', () => {
    ...
    describe('not a string', () => {
      ...
      test('parseLiteral', () => {
        expect(() =>
          GraphQLPhoneNumber.parseLiteral({ value: '123', kind: Kind.INT }, {}),
    ...
    describe('too long', () => {
      ...
      test('parseLiteral', () => {
        expect(() =>
          GraphQLPhoneNumber.parseLiteral(
            { value: '+1789555123456789', kind: Kind.STRING },
            {},
          ),
        ).toThrow(
          /^Value is not a valid phone number of the form \+17895551234 \(10-15 digits\)/,
