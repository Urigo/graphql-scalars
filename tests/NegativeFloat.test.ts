...
describe('NegativeFloat', () => {
  ...
  describe('invalid', () => {
    describe('null', () => {
      test('serialize', () => {
        expect(() => GraphQLNegativeFloat.serialize(null)).toThrow(
          /Value is not a number/,
        );
      });

      test('parseValue', () => {
        expect(() => GraphQLNegativeFloat.parseValue(null)).toThrow(
          /Value is not a number/,
        );
      });
    ...
    describe('undefined', () => {
      test('serialize', () => {
        expect(() => GraphQLNegativeFloat.serialize(undefined)).toThrow(
          /Value is not a number/,
        );
      });
    ...
    describe('infinity', () => {
      test('serialize', () => {
        expect(() =>
          GraphQLNegativeFloat.serialize(Number.NEGATIVE_INFINITY),
        ).toThrow(/Value is not a finite number/);
      });

      test('parseValue', () => {
        expect(() =>
          GraphQLNegativeFloat.parseValue(Number.NEGATIVE_INFINITY),
        ).toThrow(/Value is not a finite number/);
      });
    ...
    describe('NaN', () => {
      test('serialize', () => {
        expect(() => GraphQLNegativeFloat.serialize(Number.NaN)).toThrow(
          /Value is not a number/,
        );
      });
