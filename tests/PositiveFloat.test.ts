...
describe('PositiveFloat', () => {
  ...
  describe('invalid', () => {
    describe('null', () => {
      test('serialize', () => {
        expect(() => GraphQLPositiveFloat.serialize(null)).toThrow(
          /Value is not a number/,
        );
      });

      test('parseValue', () => {
        expect(() => GraphQLPositiveFloat.parseValue(null)).toThrow(
          /Value is not a number/,
        );
      });
    ...
    describe('undefined', () => {
      test('serialize', () => {
        expect(() => GraphQLPositiveFloat.serialize(undefined)).toThrow(
          /Value is not a number/,
        );
      });
    ...
    describe('infinity', () => {
      test('serialize', () => {
        expect(() =>
          GraphQLPositiveFloat.serialize(Number.POSITIVE_INFINITY),
        ).toThrow(/Value is not a finite number/);
      });

      test('parseValue', () => {
        expect(() =>
          GraphQLPositiveFloat.parseValue(Number.POSITIVE_INFINITY),
        ).toThrow(/Value is not a finite number/);
      });
    ...
    describe('NaN', () => {
      test('serialize', () => {
        expect(() => GraphQLPositiveFloat.serialize(Number.NaN)).toThrow(
          /Value is not a number/,
        );
      });
